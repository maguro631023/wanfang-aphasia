...
**譯詞與句型都需要母語者校對。** 程式裡有兩張表：`TR` 是單詞說法，`L10N` 是組句規則（數字、程度副詞、量詞、四種句型外框）。英語、印尼語、越南語、日語都尚未經母語者確認。校對時整段結構清楚，不需要懂程式，逐條對著改即可。

越南語的第二人稱要看對方年齡身分（anh／chị／em／cô），沒有安全的預設值，因此句型一律避開第二人稱，改用「Làm ơn」（麻煩）。這是刻意的取捨，校對時請留意不要改成需要指定稱謂的句型。

這是醫院的溝通工具，譯錯會造成誤解——特別是「身體不適」那一組。給病人使用前務必逐條確認。
